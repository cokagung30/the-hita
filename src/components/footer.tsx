...
export default function Footer() {
    ...
    const socialMedia = [
        { name: "@thehita.bali", platform: "instagram", href: "https://instagram.com/thehita.bali" },
        { name: "@igytcoffee", platform: "instagram", href: "https://instagram.com/igytcoffee" },
        { name: "@playlaundry", platform: "instagram", href: "https://instagram.com/playlaundry" },
        { name: "@the.hita", platform: "tiktok", href: "https://tiktok.com/@the.hita" },
        { name: "@igyt.coffee", platform: "tiktok", href: "https://tiktok.com/@igyt.coffee" },
        { name: "@play.laundry", platform: "tiktok", href: "https://tiktok.com/@play.laundry" },
    ];
                ...
                <div className="flex lg:flex-row flex-col gap-8 lg:gap-12 mb-12 px-4 sm:px-6 lg:px-8 pt-12 lg:pt-16">
                    ...
                    >
                        ...
                        <p className="text-white/70 text-sm leading-relaxed mb-2">
                            <span className="text-white/50 text-xs uppercase tracking-wider">The Hita Seminyak</span><br />
                            Jl. Kresna No.03, Legian,<br />
                            Kec. Kuta, Kabupaten Badung,<br />
                            Bali 80361
                        </p>
                        <p className="text-white/70 text-sm leading-relaxed mb-2">
                            <span className="text-white/50 text-xs uppercase tracking-wider">The Hita Uluwatu</span><br />
                            Jl. Raya Kampus Unud No.234, Jimbaran,<br />
                            Kec. Kuta Sel., Kabupaten Badung,<br />
                            Bali 80361
                        </p>
                        <p className="text-white/70 text-sm leading-relaxed mb-6">
                            <span className="text-white/50 text-xs uppercase tracking-wider">Sri Krisna</span><br />
                            Jl. Raya Seminyak No.16 B, Seminyak,<br />
                            Kec. Kuta, Kabupaten Badung,<br />
                            Bali 80361
                        </p>

                        <a 
                            href="https://wa.me/6282221639483"
                            ...
                            {socialMedia.map((social, idx) => (
                                <li key={idx}>
                                    ...
                                    >
                                        ...
                                        <span className="text-white text-sm group-hover:text-white/70 transition-colors">
                                            {social.name}
                                        </span>
                                    </a>
                                </li>
